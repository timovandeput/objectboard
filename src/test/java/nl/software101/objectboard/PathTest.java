...
class PathTest {
    ...
    void matchesPlainSubPath() {
        ...
        assertThat(Path.of("A/B").matches(Path.of("A/B/C"))).isTrue();
        assertThat(Path.of("A/B").matches(Path.of("A/X/C"))).isFalse();
        assertThat(Path.of("A/B/C").matches(Path.of("A/B"))).isFalse();
    }
